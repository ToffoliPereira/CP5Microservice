...
builder.Services.AddScoped<IEstoqueRepository, EstoqueRepository>(provider =>
{
    var connectionString = builder.Configuration.GetConnectionString("DefaultConnection") 
                           ?? "Server=localhost;Database=CP5;User=root;Password=123;Port=3306;";
...
builder.Services.AddScoped<IEstoqueService, ProdutoService>();
