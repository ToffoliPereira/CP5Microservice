...
namespace Service
{
    public class EstoqueService : IEstoqueService
    {
        ...
        public EstoqueService(IConfiguration configuration, ILogger<EstoqueService> logger)
        {
            _logger = logger;
        ...
        public async Task SetAsync(MovimentacaoEstoque movimentacaoEstoque, Produto produto, string key, string value, TimeSpan? expiry = null)
        {
            try
            {
